...
export default function SessionHistoryCard({
  ...
  return (
    <Pressable
      ...
      style={({ pressed }) => [styles.card, pressed ? css.buttonPressed : null]}
      onPress={onPress}
    >
        ...
        <View style={styles.innerViewStyle}>
          <View style={[css.deeBetween, { width: "100%" }]}>
            <View style={styles.upperViewStyle}>
              ...
              <MediumText>{isToday ? "Today" : getOrdinalDateAndTime(session.session_date)}</MediumText>
            </View>
            <IconButton
          ...
          <View style={{ flexDirection: "row", marginLeft: 10 }}>
            <View>
              <Image
                ...
                source={{ uri: getImageUri(Paths.IMAGE_URL, userImage) }}
              />
            </View>
            <View style={{ marginLeft: 10 }}>
              ...
              <View style={{ flexDirection: "row", marginVertical: 5 }}>
                <NormalText styleProp={{ textTransform: "capitalize" }}>{session.session_channel}</NormalText>
              </View>
            </View>
          </View>
        </View>

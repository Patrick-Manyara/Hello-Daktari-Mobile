...
export default function DocForumPost({route, navigation}) {
  ...
  return (
    <SafeAreaView style={[css.safeAreaView, {backgroundColor: '#f0f0f1'}]}>
      <ScrollView>
        {isFetching ? (
          <LoadingOverlay message="Fetching the forum" />
        ) : (
          <View>

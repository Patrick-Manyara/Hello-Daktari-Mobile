...
import AwesomeIcon from "../../components/ui/AwesomeIcon";
...
import { faBookmark, faEye, faPaperPlane } from "@fortawesome/free-regular-svg-icons";
...
export default function ForumDetailsScreen({ route, navigation }) {
    ...
    return textParts.map((part, index) => (
      <React.Fragment key={index}>
        <View style={{ flexDirection: "row", flexWrap: "wrap" }}>
          <NormalText>{part}</NormalText>
          {index < textParts.length - 1 && (
            <Pressable onPress={() => handleDoctorClick(forum.tagged_doctor)}>
              <NormalText
                boldProp={true}
        ...
        {isFetching ? (
          ...
          <View>
            ...
            <View style={styles.forumContainer}>
              ...
              <View>{formatForumText(forum, forum.forum_text)}</View>
            </View>
                  ...
                  >
                    ...
                    >
                      <View>
                        <Image
                          style={{ width: 40, height: 40, borderRadius: 20 }}
                          source={{ uri: Paths.IMAGE_URL + comment.user_image }}
                        />
                      </View>
                      <View

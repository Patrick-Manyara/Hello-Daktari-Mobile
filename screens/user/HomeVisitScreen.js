    ...
    return (
      <View style={styles.pageStyle}>
        <View style={styles.numberAreaStyle}>
          ...
          <NormalText boldProp styleProp={styles.descStyle}>Please provide information on the urgency of your medical concern</NormalText>
        </View>
      ...
      return (
        <View >
          <View style={styles.numberAreaStyle}>
            ...
            <NormalText boldProp styleProp={styles.descStyle}>Kindly select your location</NormalText>
          </View>
      ...
      >
        ...
        <View key="2">
          <View style={styles.pageStyle}>
            <View style={styles.numberAreaStyle}>
              ...
              <NormalText boldProp styleProp={styles.descStyle}>Share if you're looking for a doctor or medical professional for yourself.</NormalText>
            </View>
        ...
        <View key="3">
          ...
          <View style={styles.pageStyle}>
            <View style={styles.numberAreaStyle}>
              ...
              <NormalText boldProp styleProp={styles.descStyle}>Describe the specific area or symptoms you're experiencing (optional).</NormalText>
            </View>
            <TextAreaInput
              numberOfLines={4}
        ...
        <View key="4">
          ...
          {selectedAddress && selectedSearch && selectedUrgency ? (
            <View style={styles.pageStyle}>
              <NormalText>Your details are saved</NormalText>
              <View style={{ justifyContent: "center", alignItems: "center" }}></View>
              <Image style={styles.medicStyle} source={require('../../assets/images/medic.png')} />
